			...
			<div class="md:hidden">
				...
				>
					...
					<div class="flex items-center gap-2">
						<span class="text-sm text-gray-500">{{ supportedLocales[locale]?.nativeName }}</span>
						<svg
				...
				>
					<button
						...
						class="w-full text-start px-4 py-2.5 text-sm flex items-center gap-3 transition-colors ps-10"
						:class="locale === code
